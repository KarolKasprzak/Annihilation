...
public class Test implements ApplicationListener {
    ...
    public static  Vector3 LIGHT_POS = new Vector3(0f,0f,DEFAULT_LIGHT_Z);

    //Light RGB and intensity (alpha)
    public static  Vector3 LIGHT_COLOR = new Vector3(1f, 0.8f, 0.6f);

    //Ambient RGB and intensity (alpha)
    public static  Vector3 AMBIENT_COLOR = new Vector3(0.6f, 0.6f, 1f);

    //Attenuation coefficients for light falloff
    public static  Vector3 FALLOFF = new Vector3(.4f, 3f, 20f);
    ...
    @Override
    public void create() {
        rock = new Texture(Gdx.files.internal("test.png"));
        rockNormals = new Texture(Gdx.files.internal("test_n.png"));
    ...
    public void render() {
        ...
        LIGHT_POS.x = Gdx.input.getX() / (float)Gdx.graphics.getWidth();
        LIGHT_POS.y = (Gdx.graphics.getHeight() - Gdx.input.getY())/ (float)Gdx.graphics.getHeight();

        System.out.println(LIGHT_POS.x);
